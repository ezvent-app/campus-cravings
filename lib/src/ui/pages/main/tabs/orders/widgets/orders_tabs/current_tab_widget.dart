...
class CurrentOrdersTabWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CurrentOrdersTabWidget> createState() =>
      _CurrentOrdersTabWidgetState();
}

class _CurrentOrdersTabWidgetState
    extends ConsumerState<CurrentOrdersTabWidget> {
  @override
  void initState() {
    super.initState();
