...
class RidersDeliveryDetailsWidget extends ConsumerStatefulWidget {
  ...
  final RiderDeliveryModel? riderDeliveryModel;

  const RidersDeliveryDetailsWidget({
    super.key,
    required this.riderDeliveryModel,
...
class _RidersDeliveryDetailsWidgetState
  ...
  Widget build(BuildContext context) {
    ...
    final data = widget.riderDeliveryModel;

    String address = data?.order!.addresses!.address ?? 'No address available';
