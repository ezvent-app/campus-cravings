...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
        ...
        AutoRoute(
            page: ForgetPasswordOTPRoute.page, path: '/forget_password_OTP'),
        ...
        AutoRoute(
            page: CheckoutAddressRoute.page, path: '/check_out_address-page'),
        AutoRoute(
        ...
        AutoRoute(
            page: CheckOutAddNewAddressRoute.page, path: '/add_new-address'),
