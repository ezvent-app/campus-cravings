...
import 'package:campus_cravings/src/src.dart' as _i38;
...
/// generated route for
/// [_i1.AddPayoutPage]
class AddPayoutRoute extends _i37.PageRouteInfo<void> {
  const AddPayoutRoute({List<_i37.PageRouteInfo>? children})
...
/// generated route for
/// [_i2.AddressFormPage]
class AddressFormRoute extends _i37.PageRouteInfo<void> {
  const AddressFormRoute({List<_i37.PageRouteInfo>? children})
...
class CheckOutChatRoute extends _i37.PageRouteInfo<void> {
  const CheckOutChatRoute({List<_i37.PageRouteInfo>? children})
...
class CheckOutMapOrderTrackingRoute
    extends _i37.PageRouteInfo<CheckOutMapOrderTrackingRouteArgs> {
...
class CheckoutAddressRoute extends _i37.PageRouteInfo<void> {
  const CheckoutAddressRoute({List<_i37.PageRouteInfo>? children})
...
/// generated route for
/// [_i8.DeliverToPage]
class DeliverToRoute extends _i37.PageRouteInfo<void> {
  const DeliverToRoute({List<_i37.PageRouteInfo>? children})
...
/// generated route for
/// [_i9.DeliveringPage]
class DeliveringRoute extends _i37.PageRouteInfo<void> {
  const DeliveringRoute({List<_i37.PageRouteInfo>? children})
...
class DeliveryManProfileRoute extends _i37.PageRouteInfo<void> {
  const DeliveryManProfileRoute({List<_i37.PageRouteInfo>? children})
...
class DeliverySetupRoute extends _i37.PageRouteInfo<void> {
  const DeliverySetupRoute({List<_i37.PageRouteInfo>? children})
...
class ForgetPasswordOTPRoute extends _i37.PageRouteInfo<void> {
  const ForgetPasswordOTPRoute({List<_i37.PageRouteInfo>? children})
...
class ForgetPasswordRoute extends _i37.PageRouteInfo<ForgetPasswordRouteArgs> {
  ForgetPasswordRoute({_i38.Key? key, List<_i37.PageRouteInfo>? children})
    : super(
...
class LoginRoute extends _i37.PageRouteInfo<LoginRouteArgs> {
  LoginRoute({_i38.Key? key, List<_i37.PageRouteInfo>? children})
    : super(
        LoginRoute.name,
...
/// generated route for
/// [_i17.NewCardPage]
class NewCardRoute extends _i37.PageRouteInfo<void> {
  const NewCardRoute({List<_i37.PageRouteInfo>? children})
...
class NewPasswordRoute extends _i37.PageRouteInfo<NewPasswordRouteArgs> {
  NewPasswordRoute({_i38.Key? key, List<_i37.PageRouteInfo>? children})
    : super(
  ...
  static _i37.PageInfo page = _i37.PageInfo(
    ...
    builder: (data) {
      ...
      return _i18.NewPasswordPage(key: args.key);
    },
  );
}
...
class OrdersDetailsRoute extends _i37.PageRouteInfo<void> {
  const OrdersDetailsRoute({List<_i37.PageRouteInfo>? children})
...
/// generated route for
/// [_i22.OrdersTabPage]
class OrdersTabRoute extends _i37.PageRouteInfo<void> {
  const OrdersTabRoute({List<_i37.PageRouteInfo>? children})
...
class PaymentMethodsRoute extends _i37.PageRouteInfo<PaymentMethodsRouteArgs> {
  PaymentMethodsRoute({
    _i38.Key? key,
...
class PlacingOrderRoute extends _i37.PageRouteInfo<PlacingOrderRouteArgs> {
  PlacingOrderRoute({_i38.Key? key, List<_i37.PageRouteInfo>? children})
    : super(
  ...
  static _i37.PageInfo page = _i37.PageInfo(
    ...
    builder: (data) {
      ...
      return _i25.PlacingOrderPage(key: args.key);
    },
  );
}
...
class ProfileFormRoute extends _i37.PageRouteInfo<ProfileFormRouteArgs> {
  ProfileFormRoute({
    _i38.Key? key,
...
/// generated route for
/// [_i29.PromoCodePage]
class PromoCodeRoute extends _i37.PageRouteInfo<void> {
  const PromoCodeRoute({List<_i37.PageRouteInfo>? children})
...
/// generated route for
/// [_i30.RestaurantPage]
class RestaurantRoute extends _i37.PageRouteInfo<void> {
  const RestaurantRoute({List<_i37.PageRouteInfo>? children})
...
/// generated route for
/// [_i31.RidersDetailsPage]
class RidersDetailsRoute extends _i37.PageRouteInfo<void> {
  const RidersDetailsRoute({List<_i37.PageRouteInfo>? children})
  ...
  static _i37.PageInfo page = _i37.PageInfo(
    name,
    builder: (data) {
      return const _i31.RidersDetailsPage();
    },
  );
}
...
/// generated route for
/// [_i32.RidersTabPage]
class RidersTabRoute extends _i37.PageRouteInfo<void> {
  const RidersTabRoute({List<_i37.PageRouteInfo>? children})
  ...
  static _i37.PageInfo page = _i37.PageInfo(
    name,
    builder: (data) {
      return const _i32.RidersTabPage();
    },
  );
}

/// generated route for
/// [_i33.SavedAddressesPage]
class SavedAddressesRoute extends _i37.PageRouteInfo<void> {
  const SavedAddressesRoute({List<_i37.PageRouteInfo>? children})
  ...
  static _i37.PageInfo page = _i37.PageInfo(
    name,
    builder: (data) {
      return const _i33.SavedAddressesPage();
    },
  );
}
...
class SignUpRoute extends _i37.PageRouteInfo<SignUpRouteArgs> {
  SignUpRoute({_i38.Key? key, List<_i37.PageRouteInfo>? children})
    : super(
        SignUpRoute.name,
  ...
  static _i37.PageInfo page = _i37.PageInfo(
    ...
    builder: (data) {
      ...
      return _i35.SignUpPage(key: args.key);
    },
  );
}
...
/// generated route for
/// [_i36.StudentProfileDetailsPage]
class StudentProfileDetailsRoute extends _i37.PageRouteInfo<void> {
  const StudentProfileDetailsRoute({List<_i37.PageRouteInfo>? children})
  ...
  static _i37.PageInfo page = _i37.PageInfo(
    name,
    builder: (data) {
      return const _i36.StudentProfileDetailsPage();
    },
  );
}
