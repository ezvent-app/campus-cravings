import 'package:campus_cravings/ui/pages/delivering/widgets/delivery_details_widget.dart';
...
class _AnimatedDeliveryDetailsWrapperState extends ConsumerState<AnimatedDeliveryDetailsWrapper> {
  final double _minHeight = 257;
  late double _height;
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: Stack(
        children: [
          if(_height != _minHeight) AnimatedContainer(
            constraints: const BoxConstraints.expand(),
            color: Colors.black.withOpacity(opacity),
            duration: Duration(milliseconds: _dragging ? 0 : _animationDuration),
          ),
          Align(
                ...
                children: [
                  GestureDetector(
                    onVerticalDragUpdate: (details) {
                      ...
                      if(
                      ((_height > _minHeight || details.primaryDelta! < 0))
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if(_height != _maxHeight) const SizedBox(width: 40,)
