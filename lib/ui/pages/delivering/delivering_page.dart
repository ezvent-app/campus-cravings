...
import 'package:campus_cravings/ui/pages/delivering/widgets/animated_delivery_details_wrapper.dart';
                    ...
                    Row(
                      children: List.generate(5, (index) {
                        return Expanded(
                          child: Container(
                            height: 4,
                            margin: EdgeInsets.only(right: index == 4 ? 0 : 9, top: 12, bottom: 12),
