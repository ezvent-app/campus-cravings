                      ...
                      child: Stack(
                        children: [
                          MirrorAnimationBuilder<Color?>(
                            ...
                            tween: ColorTween(begin: Colors.black.withOpacity(.2), end: Colors.black.withOpacity(.05)),
                          ...
                          MirrorAnimationBuilder<Color?>(
                            ...
                            tween: ColorTween(begin: Colors.black.withOpacity(.4), end: Colors.black.withOpacity(.3)),
                            duration: const Duration(seconds: 1),
                          ),
                          Container(
